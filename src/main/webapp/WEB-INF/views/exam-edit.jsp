...
<html>
<head>
    <title>Edit Exam - Admin - Evalora</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .warning-box {
            background: linear-gradient(135deg, #3a3a23 0%, #2d2d1a 100%);
        ...
        .warning-box p { font-size: 13px; margin-bottom: 8px; }
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1>Edit Exam</h1>
            <p>Update exam configuration and settings</p>
        </div>
        ...
        <div class="warning-box">
            <p><strong>Warning:</strong> Updating this exam will clear all student attempts for this exam only.</p>
            <p>Other exams will not be affected.</p>
        </div>
        ...
        <form action="/admin/exams/update" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="examTitle" name="examTitle" value="${examConfig.examTitle}" required>
            </div>

            <div class="form-group">
                <label for="examDuration">Duration (minutes)</label>
                <input type="number" id="examDuration" name="examDuration" min="1" value="${examConfig.examDuration}" required>
            </div>

            <div class="form-group">
                <label for="questionCount">Number of Questions</label>
                <input type="number" id="questionCount" name="questionCount" min="1" max="${totalQuestions}" value="${examConfig.questionCount}" required>
            </div>

            <div class="form-group">
                <label for="totalMarks">Total Marks</label>
                <input type="number" id="totalMarks" name="totalMarks" min="1" value="${examConfig.totalMarks}" required>
            </div>

            <div class="form-group">
                <label for="passingMarks">Passing Marks</label>
                <input type="number" id="passingMarks" name="passingMarks" min="0" value="${examConfig.passingMarks}" required>
            </div>

            <div class="form-group">
                <label>Negative Marking</label>
                <div class="checkbox-group">
                    <input type="checkbox" id="negativeMarking" name="negativeMarking" value="true" ${examConfig.negativeMarking ? 'checked' : ''}>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-group">
                    <input type="checkbox" id="examEnabled" name="examEnabled" value="true" ${examConfig.examEnabled ? 'checked' : ''}>
                    <label for="examEnabled">Enable this exam (students can take it)</label>
                </div>
            </div>

            <div class="button-group">
                <button type="submit" class="btn btn-submit">Update Exam</button>
